...
import uz.developer.zohidjon.backend.file.FileStorageService;
import uz.developer.zohidjon.backend.history.BookTransactionHistory;
import uz.developer.zohidjon.backend.history.BookTransactionHistoryRepository;
import uz.developer.zohidjon.backend.user.User;

import java.util.List;
import java.util.Objects;

import static uz.developer.zohidjon.backend.book.BookSpecification.withOwnerId;
